...
## Project Structure
    ...
    ├── docker_test_samuel_2  # Django project configurations
...
1. Clone this repo and `cd docker_test_samuel_2`
...
2. Clone this repo and `cd docker_test_samuel_2`
